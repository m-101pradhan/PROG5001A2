...
public class MP_PlayerList
{
    // list of player objects
    private ArrayList<MP_Player> playerList;
 
    /**
     * Constructor for objects of class Player
     */
    public MP_PlayerList() {
    ...
    public void add(String name, String password) {
        MP_Player player = new MP_Player(name, password);
        playerList.add(player);
    }

    /**
     * Method to sort MP_PlayerList
    ...
    public boolean matchPlayer(String name, String password) {
        ...
        Iterator<MP_Player> iter = playerList.iterator();
        while (iter.hasNext()) {
            MP_Player player = iter.next();
    ...
    /**
     * Method to convert the MP_PlayerList to a string
     * @params none
     ...
     */
    class MP_Player implements Comparable<MP_Player> {
        public String name;
        public String password;
        
        public MP_Player(String name, String password) {
            this.name = name;
        ...
        @Override
        public int compareTo(MP_Player p) {
